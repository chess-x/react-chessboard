...
function Board() {
  ...
  const definePreview = useCallback((chessPieces, square) => {
    let pieceView = /*#__PURE__*/jsx("svg", {
      viewBox: '1 1 43 43',
      width: boardWidth / 8,
      height: boardWidth / 8,
      children: /*#__PURE__*/jsx("g", {
